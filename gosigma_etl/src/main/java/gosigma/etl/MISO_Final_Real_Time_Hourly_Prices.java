...
public class MISO_Final_Real_Time_Hourly_Prices extends FeedBase {
	...
	public MISO_Final_Real_Time_Hourly_Prices() {
		super("MISO_Final_Real_Time_Hourly_Prices");
	}
	...
	public Logger getLogger() {
		return UtilsLog.getLogger(MISO_Final_Real_Time_Hourly_Prices.class);
	}

	public static void main(String[] args) {
		FeedBase feed = new MISO_Final_Real_Time_Hourly_Prices();
		feed.doEtl(args);
	}
